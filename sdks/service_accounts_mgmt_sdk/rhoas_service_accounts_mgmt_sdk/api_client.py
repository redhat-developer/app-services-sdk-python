...
from rhoas_service_accounts_mgmt_sdk import rest
from rhoas_service_accounts_mgmt_sdk.configuration import Configuration
from rhoas_service_accounts_mgmt_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from rhoas_service_accounts_mgmt_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ServiceAccountsApi()
        api_instance.create_service_account  # this is an instance of the class Endpoint
        api_instance.create_service_account()  # this invokes api_instance.create_service_account.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_service_account.callable or self.callable in this class
