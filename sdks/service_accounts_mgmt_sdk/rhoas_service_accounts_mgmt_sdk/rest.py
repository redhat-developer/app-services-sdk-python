...
from rhoas_service_accounts_mgmt_sdk.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        try:
            ...
            if method in ['POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE']:
                ...
                if query_params and query_params[0] == ('async', True):
                    url += '?async=true'
