...
```sh
pip install dimakis_test_kafka_mgmt_sdk
```
...
If the OpenAPI document is large, imports in dimakis_test_kafka_mgmt_sdk.apis and dimakis_test_kafka_mgmt_sdk.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from dimakis_test_kafka_mgmt_sdk.api.default_api import DefaultApi`
- `from dimakis_test_kafka_mgmt_sdk.model.pet import Pet`
...
import dimakis_test_kafka_mgmt_sdk
from dimakis_test_kafka_mgmt_sdk.apis import *
from dimakis_test_kafka_mgmt_sdk.models import *
```
