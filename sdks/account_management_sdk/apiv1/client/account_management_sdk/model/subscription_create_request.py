...
class SubscriptionCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, cluster_uuid, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            plan_id (str): defaults to "OCP", must be one of ["OCP", ]  # noqa: E501
            status (str): defaults to "Disconnected", must be one of ["Disconnected", ]  # noqa: E501
        ...
        plan_id = kwargs.get('plan_id', "OCP")
