...
class CertificatesRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CertificatesRequest - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "sca", must be one of ["sca", ]  # noqa: E501
