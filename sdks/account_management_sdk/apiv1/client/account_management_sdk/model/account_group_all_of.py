...
class AccountGroupAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, managed_by, name, organization_id, *args, **kwargs):  # noqa: E501
        """AccountGroupAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, managed_by, name, organization_id, *args, **kwargs):  # noqa: E501
        """AccountGroupAllOf - a model defined in OpenAPI
