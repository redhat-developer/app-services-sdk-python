...
from account_management_sdk import rest
from account_management_sdk.configuration import Configuration
from account_management_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from account_management_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_accounts_mgmt_v1_access_token_post  # this is an instance of the class Endpoint
        api_instance.api_accounts_mgmt_v1_access_token_post()  # this invokes api_instance.api_accounts_mgmt_v1_access_token_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_accounts_mgmt_v1_access_token_post.callable or self.callable in this class
