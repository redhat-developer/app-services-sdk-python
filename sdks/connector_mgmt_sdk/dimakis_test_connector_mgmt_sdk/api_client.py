...
from dimakis_test_connector_mgmt_sdk import rest
from dimakis_test_connector_mgmt_sdk.configuration import Configuration
from dimakis_test_connector_mgmt_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from dimakis_test_connector_mgmt_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ConnectorClustersApi()
        api_instance.create_connector_cluster  # this is an instance of the class Endpoint
        api_instance.create_connector_cluster()  # this invokes api_instance.create_connector_cluster.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_connector_cluster.callable or self.callable in this class
