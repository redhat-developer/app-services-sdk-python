...
with registry_instance_sdk.ApiClient(configuration) as api_client:
...
If the OpenAPI document is large, imports in registry_instance_sdk.apis and registry_instance_sdk.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from registry_instance_sdk.api.default_api import DefaultApi`
- `from registry_instance_sdk.model.pet import Pet`
...
import registry_instance_sdk
from registry_instance_sdk.apis import *
from registry_instance_sdk.models import *
```
