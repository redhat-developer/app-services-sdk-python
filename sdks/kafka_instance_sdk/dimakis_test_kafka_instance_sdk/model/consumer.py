...
class Consumer(ModelNormal):
    ...
    attribute_map = {
        ...
        'lag': 'lag',  # noqa: E501
        'log_end_offset': 'logEndOffset',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_id, topic, partition, offset, lag, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            log_end_offset (int): The log end offset is the offset of the last message written to a log.. [optional]  # noqa: E501
            member_id (str): The member ID is a unique identifier given to a consumer by the coordinator upon initially joining the group.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, topic, partition, offset, lag, *args, **kwargs):  # noqa: E501
        """Consumer - a model defined in OpenAPI
