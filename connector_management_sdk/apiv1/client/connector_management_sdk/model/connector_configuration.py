...
class ConnectorConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kafka, service_account, connector, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, kafka, service_account, connector, *args, **kwargs):  # noqa: E501
        """ConnectorConfiguration - a model defined in OpenAPI
